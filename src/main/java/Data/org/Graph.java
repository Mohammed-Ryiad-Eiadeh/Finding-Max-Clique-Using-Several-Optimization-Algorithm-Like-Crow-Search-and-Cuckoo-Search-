...
public final class Graph {
    ...
    public Graph(String DataFile) {
        try (var resource = new Scanner(new File(DataFile))) {
            Read = resource;
            var NumOfNode = Integer.parseInt(Read.nextLine());
    ...
    private void CreatGraphAsAdjacencyMatrix() {
        while (Read.hasNext()) {
            var Edge = Read.nextLine();
            var TwoVertex = Edge.split("\s");
